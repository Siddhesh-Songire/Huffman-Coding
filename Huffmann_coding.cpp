...
Node *getNode(char ch, int freq, Node *left, Node *right) // will return pointer of node type
{
	Node *node = new Node();
...
void buildHuffmanTree(string text)
{
	...
	//* Next step is to pop the two lowest frequency character and add them together
